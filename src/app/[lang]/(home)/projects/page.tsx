...
export default async function ProjectsPage({
  ...
  return (
    <div className="relative flex flex-1 overflow-hidden">
      <GitInfoButton />
      <Spotlight />
      <div className="xs:px-5 mx-auto flex max-w-md flex-1 flex-col items-center justify-center gap-8 px-4 md:max-w-4xl md:px-12 lg:flex-row lg:py-0 xl:max-w-[1200px]">
        <div className="w-full space-y-6 py-32">
            ...
            {projects.map((project) => (
              ...
              >
                <div className="flex h-full flex-col">
                  <div className="relative aspect-video flex-0">
                    {project.banner ? (
                      <Image
                        src={project.banner}
