...
export function CommunityCta() {
  ...
  const [rows, setRows] = useState(() => ({
    ...
    rowTwo: [...COMMUNITY_PHOTOS]
      .reverse()
      .concat([...COMMUNITY_PHOTOS].reverse()),
  }));
    ...
    <section className="my-24 space-y-10 overflow-hidden">
      ...
      <FadeIn className="mx-auto max-w-4xl px-4 text-center">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          ...
          <Button asChild>
            <Link href="/en/docs/official-documentation/worldgen/pack-tutorial/asset-packs">
              {t.firstAsset}
              <ArrowRightIcon />
            </Link>
          </Button>
          <Button asChild>
            <Link href="/en/docs/guides/plugin/setting-up-env">
              {t.firstMod}
              <ArrowRightIcon />
            </Link>
          </Button>
