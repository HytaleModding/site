---
title: Пример ECS плагина
description: В этом руководстве вы узнаете, как создать простую систему отправления (эффект), используя все функции, о которых вы ранее узнали из системы ECS Hytale.
authors:
  - name: oskarscot
