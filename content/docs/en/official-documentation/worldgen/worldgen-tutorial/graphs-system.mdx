...
<table>
  <tbody>
    ...
    <tr>
      <td>**Content**</td>
      <td>Contains Density, Material, PropDistributions, and/or Position information.</td>
    </tr>
    <tr>
      <td>**Nodes**</td>
    ...
    <tr>
      ...
      <td>A list of actions to modify nodes, create edges, or define Content.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Defines the Density, Material, PropDistributions, and/or Positions information per Node.</td>
    </tr>
    <tr>
      <td>&emsp;&emsp;**EdgeActions**</td>
      <td>A list of actions to modify edges or split into Nodes for Content.</td>
    </tr>
    <tr>
      <td>&emsp;&emsp;&emsp;&emsp;**Splitter**</td>
      <td>Splits up an Edge into a designated amount of Nodes in a line to define content along. This can be used instead of the DistanceFromGraphEdge Density node which may be expensive.</td>
    </tr>
    <tr>
      <td>&emsp;&emsp;**Node/Edge Selectors**</td>
      <td>Allows precise control over which Nodes or Edges to perform actions on.</td>
    </tr>
    <tr>
      <td>**Graph “Connections”**</td>
      <td>These nodes are how you use Content defined in Graphs inside your Biome file.</td>
    </tr>
    <tr>
      <td>**Content Layer**</td>
      <td>This value is the bridge between a Connection and defined Content in a Graph.</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      <td>Here's an example of defining as much Content as we can into Nodes where each Node has a Cylinder defined out of Density, a Gold Material coating the cylinder, with a Dungeon Room PropDistribution placed underneath, with a Position that will be used to point to a chest on top of the Cylinder.</td>
    </tr>
    <tr>
      <td>![Content Example](/assets/official-documentation/worldgen/graphs/content-example.webp)</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    ...
    <tr>
      <td>![Density Connection](/assets/official-documentation/worldgen/graphs/connection-density.webp)</td>
      <td>![Material Connection](/assets/official-documentation/worldgen/graphs/connection-material.webp)</td>
    </tr>
        <tr>
    ...
    <tr>
      <td>![Prop Distributions Connection](/assets/official-documentation/worldgen/graphs/connection-prop.webp)</td>
      <td>![Positions Connection](/assets/official-documentation/worldgen/graphs/connection-positions.webp)</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      <td>This example continues off of the previous example. Here we are extracting the previously defined Positions Content to place a chest on top of our Density defined Cylinder.</td>
    </tr>
    <tr>
      <td>![Connection Example](/assets/official-documentation/worldgen/graphs/connection-example.webp)</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      <td>This is an example of expanding an IcyCave Content to its Connected Nodes!</td>
    </tr>
    <tr>
      <td>![Connected Example](/assets/official-documentation/worldgen/graphs/action-connected-example.webp)</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      <td>Based on the Previous NodeSelectors section, this setup would work as well!</td>
    </tr>
    <tr>
      <td>![Connected Alt Example](/assets/official-documentation/worldgen/graphs/action-connected-example-alt.webp)</td>
    </tr>
  </tbody>
</table>
