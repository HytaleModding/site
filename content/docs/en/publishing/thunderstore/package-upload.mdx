...
5. Once done you'll see a Text Box right of the word `Categories` appear, in this box you will select all of the tags that correlate to your Package. See [Thunderstore Prequisites](./guides/publishing/thunderstore) for what each Tag means and corresponds with.
