...
| Component             | Purpose                         |
| --------------------- | ------------------------------- |
| `ProjectileComponent` | Base entity type                |
| `TransformComponent`  | Sets where the hologram appears |
| `UUIDComponent`       | Gives it a unique ID            |
| `Intangible`          | ---                             |
...
| Component             | Purpose                         |
| --------------------- | ------------------------------- |
| `NetworkId`           | Syncs the entity to clients     |
