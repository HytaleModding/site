...
**Challenge**: Make a Treasure Goblin who flees from the player, and explodes in a loot pile when F interact is triggered. Here are 2 guides that can help you get started
...
> Hint: The Rabbit has both fleeing and F interact with out the 180 degree cone
>
