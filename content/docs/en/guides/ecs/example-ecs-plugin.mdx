...
description: "In this guide you will learn how to create a simple poison system utilizing all of the features you previously learned about Hytale's ECS system"
authors:
    - name: "oskarscot"
...
public class PoisonComponent implements Component<EntityStore> {
  ...
  // NOTE: You must specify the codec when adding the component to the store for it to save and load data.
...
public class ExampleCommand extends AbstractPlayerCommand {
  ...
  protected void execute(@Nonnull CommandContext commandContext, @Nonnull Store<EntityStore> store, 
    ...
    store.addComponent(ref, PoisonComponent.getComponentType(), poison, PoisonComponent.CODEC);
