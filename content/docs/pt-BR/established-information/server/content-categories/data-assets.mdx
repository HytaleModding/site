...
description: Informações sobre ativos de dados no Hytale e como eles influenciam comportamento do jogo e criação de conteúdo.
---
...
* **Fluxo de trabalho integrado**: funciona diretamente no editor de ativos do Hytale para um conjunto unificado de criação
