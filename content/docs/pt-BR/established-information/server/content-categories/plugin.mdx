...
#### Preocupações com o Singleplayer

Apesar do nome, os plugins de servidores também são usados no modo singleplayer.
O modo singleplayer do Hytale roda um servidor local, que permite jogadores usarem os plugins de servidores mesmo jogando sozinhos. Isso significa que mods criados como plugins de servidores podem ser usados na experiência singleplayer.
