---
title: 5.3 — CSS personalizado
description: Como personalizar a aparência da sua wiki.
authors:
  - name: Dobya
...
Por padrão, `--radius` não é aplicado aos cartões, mas você pode conectá-lo manualmente:
