...
Na maioria das vezes, construir NPCs começa com o mesmo conjunto de etapas iniciais:

1. Leia toda a documentação do projeto;
2. Entenda como o comportamento se divide em diferentes estados;
3. Identifique quais partes do comportamento já existem em componentes predefinidos;
4. Identifique quais partes do comportamento provavelmente vão ser reutilizadas em outros modelos semelhantes;
5. (Opcional) Identifique quais partes do comportamento são especialmente complexas e têm chance de virar algo reutilizável de forma geral.

Neste tutorial, vamos trabalhar com o **Goblin Ogre**.

**Requisitos mínimos de design que recebemos:**

1. Um NPC grande e lento, com muita vida, encontrado em POIs específicos;
2. Pode seguir um caminho predeterminado e ficar de guarda nessa posição;
3. Pode dormir e, se outros goblins perturbarem o Goblin Ogre enquanto ele dorme, ele tem uma reação especial de "sonolência";
4. Pode invocar ratos para comer;
5. Tem um ataque corpo a corpo.

**Observação:** Para os fins deste tutorial, vamos seguir este briefing de design, embora ele talvez não reflita mais o NPC usado no jogo.

---

### Etapa 1: Leia a documentação!
