---
title: Como editar e criar biomas
description: Explore onde os recursos de geração de mundo podem ser encontrados e como editá-los.
icon: Pencil
authors:
...
<div className="flex flex-row gap-2">
  <div className="flex-1">
    ...
    Os arquivos geradores definem quais serão os biomas que aparecerão juntos.
  </div>
