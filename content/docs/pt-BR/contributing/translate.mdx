...
3. Caso queira se juntar a um tópico, você deve executar o comando `/translator <your-language>`. O bot lhe adicionará ao tópico para o idioma escolhido.
...
<div translate="no">
{/*
Para os tradutores que editarão esta página:

- Vocês devem traduzir as diretrizes à medida que elas mudam.
- As diretrizes gerais devem ser traduzidas, mas não editadas.
- Aprenda como usar Markdown em [Escrevendo guias](.contributing/writing_guides)
*/}
</div>
