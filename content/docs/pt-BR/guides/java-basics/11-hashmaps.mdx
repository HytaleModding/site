...
// Output: Alice, Bob, Charlie (a ordem pode mudar)
```
...
// Output: 100, 150, 75 (a ordem pode mudar)
```
...
<Callout type="info" title="Ordem do HashMap">
  ...
  // Output: Alice, Bob, Charlie (ordem garantida)
  ```
</Callout>
...
public class Main {
    public static void main(String[] args) {
        ...
        db.displayItem("Espada de Ferro");
    }
}
```
...
public class Player {
    ...
    public String toString() {
        return name + " (Nível " + level + ", Vida: " + health + ")";
    }
}
...
4. **Loja de itens**: crie uma loja onde os itens têm nomes e preços. Adicione métodos para:
