...
A precendência de operadores significa qual operador é avaliado primeiro em uma linha de código. Pense nisso como a ordem das operações na matemática: parênteses, expoentes, multiplicação, divisão, adição e subtração!
