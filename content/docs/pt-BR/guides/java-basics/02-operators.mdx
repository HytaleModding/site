...
Operator Precedence means which operator gets evaluated first in an line of code. Pense nisso como a ordem das operações na matemática: parênteses, expoentes, multiplicação, divisão, adição e subtração!
