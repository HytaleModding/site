---
title: Criando ouvintes de eventos
description: Aprenda a criar ouvintes de eventos para o seu mod de Hytale.
authors:
  - name: Neil Revin
...
Você pode importar uma classe Event e criar uma função com o Event como argumento. [Clique aqui](../../server/events) para ver todos os eventos disponíveis.
...
## Classes de eventos do ECS

Para eventos que se enquadram na lista de [Eventos do ECS](../../server/events#ecsevent) você precisará criar e registrar um sistema de eventos de entidade.
