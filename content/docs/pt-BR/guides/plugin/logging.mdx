...
Existe o método `.forEnclosingClass()` que pode ser utilizado para obter automaticamente o registrador do arquivo em uso, sem a necessidade de alterá-lo manualmente a cada nova implementação.
