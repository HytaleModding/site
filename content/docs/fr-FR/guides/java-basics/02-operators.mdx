...
int reste = a % b;  // Modulus (remainder): 0
```
...
```java
String salutation = "Hello, " + "world!"; // "Hello, world!"
String nom = "Alice";
String salutationAvecNom = "Hello, " + name + "!"; // "Hello, Alice!"
```

## Opérateur de priorité

L'opérateur de priorité signifie que l'opéraeur est évalué en premier dans la ligne de code. Pensez à ça comme PEMDAS (Paranthèse, Exposant, Multiplication, Division, Addition, Soustraction) :
