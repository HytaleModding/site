...
So now you may be wondering well hey, how do I upload the package now that I've gone through all the Setup for it? To answer that question here is a step by step on creating a Team than a step by step on Uploading the Package, it's actually _**extremely**_ simple to get through!
...
- Disband: This will disband the team and can _**only**_ be used if the team has uploaded no packages to the site.
